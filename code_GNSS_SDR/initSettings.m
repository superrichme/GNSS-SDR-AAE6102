...
%settings.numberOfChannels   = 4; %urban
settings.numberOfChannels   = 5; %opensky
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%settings.fileName           = ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 'D:\Project\Completed\GNSS SSK\Gsk_App_Sampler\GskApp\GskAppDiag\MAX2769C_GPS_L1_16368_4092_I1_20210727_171432.dat';
...
%=======================================urban==============================================
% settings.IF                 = 0e6;       %[Hz] Intermediate frequency
% settings.samplingFreq       = 26e6;         %[Hz] Sampling frequency
settings.codeFreqBasis      = 1.023e6;      %[Hz]
...
settings.acqThreshold       = 2.5;%opensky
%settings.acqThreshold       = 2.2;%urban
...
settings.dllCorrelatorSpacing    = 0.8;     %[chips]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%调小0.1/      0.2opt      
