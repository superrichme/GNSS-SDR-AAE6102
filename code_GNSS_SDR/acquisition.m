...
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Ensure the input signal is at least 11ms
% requiredSamples = round(11e-3 * settings.samplingFreq);
% if length(longSignal) < requiredSamples
%     error('Input signal is too short. At least 11ms of data is required.');
% end
% 
% % Down-convert the signal to baseband if IF is non-zero
% if settings.IF ~= 0
%     t = (0:length(longSignal)-1) / settings.samplingFreq;
%     carrier = exp(-1i * 2 * pi * settings.IF * t);
%     longSignal = longSignal .* carrier; % Down-convert to baseband
% end
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
% signal0DC = longSignal - mean(real(longSignal)) - 1i * mean(imag(longSignal));
% 
...
%and frequency of the detected signals in the "acqResults" structure.
%
%Modified for Opensky.bin data (IF=4.58 MHz, Sampling Freq=58 MHz)
